...
"}")
        ...
        self.label_title.setStyleSheet(u"color: rgb(213, 214, 232);")
...
"}")
        ...
        self.label_loading.setStyleSheet(u"color: rgb(213, 214, 232);")
        ...
        self.label_credits.setStyleSheet(u"color: rgb(213, 214, 232);")
    ...
    def retranslateUi(self, SplashScreen):
        ...
        self.label_title.setText(QCoreApplication.translate("SplashScreen", u"<strong>UDIS</strong>", None))
        ...
        self.label_credits.setText(QCoreApplication.translate("SplashScreen", u"<strong>Created</strong>: UDIS, Ethiopia", None))
    # retranslateUi
